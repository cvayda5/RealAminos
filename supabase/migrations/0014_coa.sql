...
-- each compound, its third-party test results, and a link to the actual
-- signed PDF (served from /public/coa — see the file list below). This
-- replaces the placeholder/demo copy in src/app/lab/CoaLookup.tsx and the
-- generic "available on request" line on the product detail page.
--
