  ...
  return (
    <main className="site-main">
      <div className="legal-body" style={{ padding: "36px 0 60px" }}>
        ...
        <p>
          Because our products consist of peptides and amino acids with strict temperature and
          environmental sensitivities, we cannot accept returns or provide refunds for
          change-of-mind or order errors due to the high risk of product degradation.
        </p>
        <p>
        ...
        <p>
          If an authorized return or exchange is approved by our team, we will provide the return
          shipping address for our processing facility at that time.
        </p>

        <h3>Lost Shipments &amp; Missing Items</h3>
        <p>
          If a shipment has been lost by the carrier (e.g., FedEx, UPS) and it is not recovered,
          and the delivery confirmation report shows a non-delivery, then we will reship the order
          at no cost to you. However, if a shipment is claimed to be lost but the carrier&apos;s
          delivery confirmation officially shows &quot;delivered,&quot; our delivery guarantee has
          been fulfilled, and we will not reship free of charge.
        </p>
        <p>
          ...
          prior to shipping to prevent fraudulent claims.
        </p>
        ...
        <p>
          ...
          defective item to us and immediately dispatch your replacement.
        </p>

        <h3>How Are Chargebacks Handled?</h3>
        <p>
