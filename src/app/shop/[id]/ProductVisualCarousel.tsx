...
// Slide 1 is always the product visual (the CSS vial mark). Slide 2 — the
// Certificate of Analysis for the current lot — only appears when the
// product actually has one (BAC Water, or a not-yet-tested product, won't).
